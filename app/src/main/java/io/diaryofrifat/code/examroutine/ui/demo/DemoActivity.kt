package io.diaryofrifat.code.examroutine.ui.demo
...
import io.diaryofrifat.code.examroutine.databinding.ActivityDemoBinding
...
class DemoActivity : BaseActivity<DemoMvpView, DemoPresenter>() {
    ...
    override fun startUI() {
        ...
        setClickListener(mBinding.buttonDo as View)
    }
