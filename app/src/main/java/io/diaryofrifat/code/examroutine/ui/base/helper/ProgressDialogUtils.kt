package io.diaryofrifat.code.examroutine.ui.base.helper
...
class ProgressDialogUtils private constructor() {
    ...
    fun showProgressDialog(context: Context): AlertDialog? {
        ...
        val view = View.inflate(context, R.layout.progresss_dialog_layout, null)

        view?.text_view_message?.setTypeface(null, Typeface.NORMAL)
